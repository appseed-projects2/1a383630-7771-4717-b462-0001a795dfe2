...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-21 22:02`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/1a383630-7771-4717-b462-0001a795dfe2.git
$ cd 1a383630-7771-4717-b462-0001a795dfe2
```
